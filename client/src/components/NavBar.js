    ...
    <>
      <div>
        <div style={containerStyles}>
          ...
          <NavLink style={linkStyles} activeClassName='navbar--active' exact to='/'>Home</NavLink>
          <NavLink style={linkStyles} activeClassName='navbar--active' to='/users'>Users</NavLink>
          <NavLink style={linkStyles} activeClassName='navbar--active' to='/library/artists'>Library</NavLink>
